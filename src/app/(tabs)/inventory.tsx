          ...
          >
            ...
            >
              ...
              <View className={`w-5 h-5 rounded-full border-2 ${
                showLowStockOnly ? 'bg-amber-500 border-amber-500' : 'border-amber-500/50'
                    ...
                    <View className="flex-row items-start justify-between">
                      <View className="flex-1">
                        ...
                        <View className="flex-row items-center gap-4">
                          <View>
                            <Text className="text-stone-600 text-xs">Cost</Text>
                            <Text className="text-stone-400 text-sm">{formatNaira(product.costPrice)}</Text>
                          </View>
                          <View>
                            <Text className="text-stone-600 text-xs">Sell</Text>
                            <Text className="text-orange-400 text-sm font-medium">{formatNaira(product.sellingPrice)}</Text>
                          </View>
                          <View>
                            <Text className="text-stone-600 text-xs">Margin</Text>
                      ...
                      <View className="items-end">
                        <View className={`px-3 py-1 rounded-lg ${
                          isLowStock ? 'bg-amber-500/20' : 'bg-stone-800'
                        }`}>
                        ...
                        <Text className="text-stone-600 text-xs mt-1">{product.unit}</Text>
                      </View>
                    </View>
                  </Pressable>
                </Animated.View>
            ...
            <ScrollView className="max-h-[500px]" showsVerticalScrollIndicator={false}>
              <View className="p-6">
                ...
                <View className="gap-4">
                  ...
                  <View>
                    <Text className="text-stone-400 text-sm mb-2">Barcode (Optional)</Text>
                    <TextInput
                      className="bg-stone-800 rounded-xl px-4 py-3 text-white"
                  ...
                  <View>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ flexGrow: 0 }}>
                      {categories.map((cat) => (
                        ...
                        >
                          <Text className={formData.category === cat.name ? 'text-white font-medium' : 'text-stone-400'}>
                            {cat.name}
                          </Text>
                        </Pressable>
                      ))}
                  ...
                  <View className="flex-row gap-3">
                    <View className="flex-1">
                      <Text className="text-stone-400 text-sm mb-2">Initial Stock</Text>
                      <TextInput
                        className="bg-stone-800 rounded-xl px-4 py-3 text-white"
                        placeholder="0"
                        placeholderTextColor="#57534e"
                    ...
                    <View className="flex-1">
                      <Text className="text-stone-400 text-sm mb-2">Low Stock Alert</Text>
                      <TextInput
                        className="bg-stone-800 rounded-xl px-4 py-3 text-white"
                        placeholder="10"
                        placeholderTextColor="#57534e"
              ...
              {selectedProduct && (
                <>
                  <View className="bg-stone-800/50 rounded-xl p-4 mb-6">
                    <Text className="text-white font-medium text-lg mb-1">{selectedProduct.name}</Text>
                  ...
                  <View className="mb-6">
                    <Text className="text-stone-400 text-sm mb-2">Quantity to Add/Remove</Text>
                    <TextInput
                  ...
                  <View className="flex-row gap-3">
                    <Pressable
                      ...
                      className="flex-1 flex-row items-center justify-center gap-2 bg-red-500/20 border border-red-500/40 py-4 rounded-xl active:opacity-90"
                    >
                    ...
                    <Pressable
                      ...
                      className="flex-1 flex-row items-center justify-center gap-2 bg-emerald-500/20 border border-emerald-500/40 py-4 rounded-xl active:opacity-90"
                    >
