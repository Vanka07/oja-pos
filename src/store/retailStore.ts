...
const sampleCustomers: Customer[] = [
  {
    ...
    currentCredit: 12500,
    transactions: [
      { id: 't1', type: 'credit', amount: 15000, createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString() },
      { id: 't2', type: 'payment', amount: 2500, createdAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() },
    ],
    createdAt: new Date().toISOString(),
  },
  {
