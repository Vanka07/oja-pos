...
const client = new pg.Client({
  host: 'db.bjpqdfcpclmcxyydtcmm.supabase.co',
  port: 5432,
  database: 'postgres',
  user: 'postgres',
  password: '3hi7NI0uMAZ1Bgl3',
...
drop policy if exists "Service role full access shops" on shops;
drop policy if exists "Service role full access shop_members" on shop_members;
...
-- Allow insert on shops for authenticated users (they need to create their shop)
...
-- Allow insert on shop_members for authenticated users
